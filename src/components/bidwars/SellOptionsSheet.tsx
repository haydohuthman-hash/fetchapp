    ...
    >
      ...
      >
        ...
        <header className="flex flex-col items-center gap-1 px-2 pb-2 pt-1 text-center">
          <p className="text-[10px] font-black uppercase tracking-[0.18em] text-[#291050]">Sell on Fetchit</p>
  ...
  return (
    <button
      ...
      className={[
        ...
        tone === 'purple'
          ? 'bg-gradient-to-br from-[#7c3aed] via-[#5b21b6] to-[#291050] text-white ring-[#291050]/20 shadow-[0_18px_40px_-20px_rgba(41,16,80,0.6)]'
    ...
    >
      <span
        className={[
          ...
          tone === 'purple' ? 'bg-white/15 ring-1 ring-white/20' : 'bg-violet-100 text-[#291050]',
        ].join(' ')}
      >
        {icon}
      </span>
