...
export function DropsFlameNavIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden>
      <path
        fill="currentColor"
...
/**
 * Chat — speech bubble + tail; scaled up in-viewBox so it matches account/bell at the same CSS size.
 */
export function ChatNavIconFilled({ className }: IconProps) {
  const d =
    'M8 7.25L16 7.25A1.75 1.75 0 0117.75 9L17.75 14A1.75 1.75 0 0116 15.75L12.15 15.75L11 17.95L9.85 15.75L8 15.75A1.75 1.75 0 016.25 14L6.25 9A1.75 1.75 0 018 7.25z'
  const bubble = (
