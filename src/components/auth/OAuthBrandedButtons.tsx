...
/** Apple HIG–style control: black field, white glyph + label. */
...
/** Google multi-color “G” mark (brand colors). */
...
export function OAuthBrandedButtons({ onApple, onGoogle, disabled }: Props) {
  return (
