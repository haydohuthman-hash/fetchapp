...
function HowItWorksSheet({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="fetch-sheet-surface rounded-t-[1.75rem] border-t border-violet-200/50 bg-white px-6 pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] pt-5 shadow-[0_-8px_40px_rgba(41,16,80,0.08)]">
          {/* Handle */}
          <div className="mx-auto mb-5 h-[5px] w-10 rounded-full bg-zinc-600" />

          {/* Header */}
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#291050]">
          ...
          <div className="flex flex-col gap-4">
            {STEPS.map((s, i) => (
              <div key={i} className="flex items-start gap-3.5">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-violet-100 ring-1 ring-violet-200/60 text-[#291050]">
                  {s.icon}
                </div>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2">
            <span className="flex items-center gap-1 rounded-full bg-violet-50 px-2.5 py-1 text-[11px] font-bold text-[#291050] ring-1 ring-violet-200/60">
              <BoltNavIcon className="h-3 w-3 text-[#291050]" />
              Same-day delivery
            </span>
            <span className="rounded-full bg-violet-100 px-2.5 py-1 text-[11px] font-bold text-[#291050]">
              Next-day available
            </span>
            <span className="rounded-full bg-violet-100 px-2.5 py-1 text-[11px] font-bold text-[#291050]">
              Free pickup
          ...
          <button
            type="button"
            onClick={cont}
            className="mt-6 flex w-full items-center justify-center rounded-2xl bg-[#291050] py-3.5 text-[14px] font-bold text-white transition-transform active:scale-[0.98]"
          >
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        <div className="fetch-sheet-surface flex h-full min-h-0 flex-col rounded-t-[1.75rem] border-t border-violet-200/50 bg-white text-[#1c1528] shadow-[0_-8px_40px_rgba(41,16,80,0.08)]">
          {/* Handle */}
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            ...
            {/* Sticky CTAs */}
            <div className="shrink-0 border-t border-violet-200/50 bg-white px-5 pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] pt-3 shadow-[0_-4px_16px_-4px_rgba(41,16,80,0.06)]">
      ...
      >
        ...
        <header className="relative z-10 flex shrink-0 items-center gap-3 border-b border-violet-200/40 bg-white px-4 pb-3 pt-[max(0.85rem,env(safe-area-inset-top,0px))]">
          <button
            type="button"
            onClick={dismiss}
            className="flex h-9 w-9 items-center justify-center rounded-full bg-violet-100 text-[#291050] transition-colors hover:bg-violet-200 active:scale-[0.98]"
            aria-label="Back"
          >
        ...
        <div className="flex shrink-0 items-center gap-2 border-b border-violet-200/40 bg-violet-50 px-4 py-2">
          <BoltNavIcon className="h-3.5 w-3.5 shrink-0 text-[#291050]" />
          <p className="text-[11px] font-semibold text-[#291050]">
