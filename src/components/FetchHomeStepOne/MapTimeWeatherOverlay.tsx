          ...
          <div
            ...
            className={[
              ...
              appleDriving
                ...
                : 'gap-0.5 rounded-2xl border border-white/12 bg-[rgba(15,31,74,0.55)] px-3.5 py-2 backdrop-blur-md backdrop-saturate-[1.12]',
            ].join(' ')}
            role="status"
            aria-live="polite"
            aria-atomic="true"
            ...
            {exploreLayout ? (
              <>
                ...
                {navStrip.exploreSubtitle ? (
                  <p className="line-clamp-2 text-[11px] font-medium leading-snug text-white/72">
                    {navStrip.exploreSubtitle}
                  </p>
                ) : null}
              </>
              ...
              <>
                ...
                {navStrip.distanceToManeuverLabel ? (
                  <p className="text-[11px] font-semibold tabular-nums tracking-[-0.01em] text-white/78">
                    {navStrip.distanceToManeuverLabel}
                  </p>
                ) : null}
        ...
        ? createPortal(
            <div className="fetch-home-map-help-root fixed inset-0 z-[58] flex items-center justify-center p-4">
              ...
              >
                ...
                <button
                  type="button"
                  className="mt-5 w-full rounded-xl bg-white/[0.12] py-2.5 text-[14px] font-semibold text-white transition-colors hover:bg-white/[0.18]"
                  onClick={() => setHelpOpen(false)}
                >
                  Got it
                </button>
              ...
              >
                ...
                <div className="mt-4 flex flex-col gap-2">
                  <a
                    ...
                    className="rounded-xl border border-white/[0.1] bg-white/[0.05] px-4 py-3 text-center text-[14px] font-medium text-white/85 transition-colors hover:bg-white/[0.08]"
                  >
                    Privacy (web)
                  </a>
                  <a
