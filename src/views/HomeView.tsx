          ...
          {showPostScan && bookingState.bookingStatus && isLivePipelinePersistedStatus(bookingState.bookingStatus)
            ...
            <section className="fetch-home-booking-step fetch-home-booking-step--stack w-full">
              ...
              {stripeBookCheckout && import.meta.env.VITE_STRIPE_PUBLISHABLE_KEY?.trim() ? (
                <div className="mt-3 rounded-2xl border border-violet-200/60 bg-white p-3">
      ...
      homeBrainFlow == null ? (
        <div className="fetch-home-search-route absolute inset-0 z-[52] flex min-h-dvh flex-col bg-[#f8f6fd]">
          ...
          {pendingSearchCategoryChoice ? (
            <div
              className="fixed inset-0 z-[61] flex flex-col justify-end bg-[#1c1528]/40 backdrop-blur-[2px]"
              role="presentation"
            >
              <button
                type="button"
