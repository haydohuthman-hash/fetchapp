...
import { BoltNavIcon, DropsFlameNavIcon, FetchEyesHomeIcon } from '../components/icons/HomeShellNavIcons'
import {
  postFetchAiChat,
...
export default function HomeView({
  ...
  const onAppTopAccount = useCallback(() => {
    bumpInteraction()
    onAccountNavigate?.()
  ...
  const exploreFullPageMainTopPad = useMemo(() => {
    return 'pt-[max(0.5rem,env(safe-area-inset-top,0px))]'
  ...
  const homeShellFooterNav = useMemo(
    ...
    [bumpInteraction, homeShellTab, onHomeShellTabChange, onPeekHomeClick, setDropsNavRepeatTick],
  )
  ...
  return (
    ...
    >
      ...
      {!brainImmersive && servicesExploreFullPage ? (
        <>
        <div className="fetch-explore-full-page-shell absolute inset-0 z-[52] flex min-h-dvh flex-col bg-[#000000]">
          {!forYouLoaded ? (
            <main
              className={[
                'mx-auto flex min-h-0 w-full max-w-[min(100%,430px)] flex-1 flex-col bg-[#000000] pb-2',
            ...
            <main
              className={[
                'mx-auto flex min-h-0 w-full max-w-[min(100%,430px)] flex-1 flex-col bg-[#000000] px-3 pb-2 animate-[fetch-for-you-fadein_0.45s_ease_both]',
                exploreFullPageMainTopPad,
              ].join(' ')}
              role="main"
              aria-label="Explore"
      ...
      cardVisible &&
      homeBrainFlow == null ? (
        <div className="fetch-home-search-route absolute inset-0 z-[52] flex min-h-dvh flex-col bg-black">
          <main
            className="fetch-home-search-categories mx-auto flex min-h-0 w-full max-w-[min(100%,430px)] flex-1 flex-col bg-black px-3 pb-2 pt-[calc(max(0.5rem,env(safe-area-inset-top,0px))+6.1rem)]"
            role="main"
            aria-label="Search"
          >
            <div className="fetch-home-search-categories__scroll min-h-0 flex-1 overflow-y-auto overscroll-contain [-webkit-overflow-scrolling:touch] pr-0.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              <section className="mt-6 min-w-0 py-2" aria-label="Search categories">
                <div
                  className={[
                    'mb-3 flex w-full gap-0.5 rounded-2xl border border-white/[0.055] bg-[rgba(0,0,0,0.92)] p-[5px]',
                    'shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_8px_28px_-12px_rgba(0,0,0,0.9)]',
                    'backdrop-blur-xl backdrop-saturate-[1.2] [-webkit-backdrop-filter:blur(20px)_saturate(1.2)]',
                  ].join(' ')}
                  role="tablist"
          ...
          {pendingSearchCategoryChoice ? (
            ...
            >
              ...
              <div
                ...
                className="relative z-[1] mx-auto w-full max-w-[min(100%,430px)] rounded-t-2xl border border-white/10 bg-[#000000] px-0 pb-[max(1rem,env(safe-area-inset-bottom))] pt-1 shadow-[0_-14px_44px_rgba(0,0,0,0.55)]"
              >
