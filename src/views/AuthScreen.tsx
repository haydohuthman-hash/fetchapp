...
export default function AuthScreen({ onSignedIn, onBack }: AuthScreenProps) {
  ...
  return (
    <div className="mx-auto flex min-h-dvh min-h-[100dvh] w-full max-w-lg flex-col bg-fetch-soft-gray">
      <header className="relative flex shrink-0 flex-col bg-[#1a1d22] px-5 pt-[max(0.65rem,env(safe-area-inset-top))] pb-6 shadow-[0_1px_0_rgba(255,255,255,0.06)] dark:bg-[#1a1d22] dark:shadow-none">
        <button
          type="button"
          onClick={onBack}
